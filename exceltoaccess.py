...
if __name__ == "__main__":
    ...
    br=r'F:\地价\2019区段\x7'
    r=[r'静安—租赁样点价格信息更新1021.xls',r'静安—住宅样点价格信息更新1021.xls',r'静安—商业样点价格信息更新1021.xls',r'办公样点价格信息更新.xls']
    r2=[r'虹口—办公样点信息更新1021.xls',r'虹口—商业样点信息更新.xls',r'虹口—住宅样点信息更新.xls',r'虹口—租赁样点信息更新.xls']
   ...
   # r'虹口—住宅样点信息更新.xls',r'虹口—商业样点信息更新.xls',r'虹口—办公样点信息更新1021.xls‘
    thread=[]
    t1=thred(br,r,"表格\\\静安\\静安样点信息.mdb")
    t2=thred(br,r2,"表格\\\虹口\\虹口样点信息.mdb")
    t1.start()
    t2.start()
    thread.append(t1)
    thread.append(t2)
