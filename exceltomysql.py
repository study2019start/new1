...
if __name__ == "__main__":
    ...
    r= [r'办公区段子单元—静.xls',r'住宅区段子单元—静.xls',r'租赁区段子单元—静.xls',r'商业区段子单元—静.xls']
    r2=[r'办公区段子单元—虹.xls',r'住宅区段子单元—虹.xls',r'租赁区段子单元—虹.xls',r'商业区段子单元—虹.xls']
    thread=[]
    t1=thred(br,r,"3.2014年区段子单元—静安 - 副本.mdb")
